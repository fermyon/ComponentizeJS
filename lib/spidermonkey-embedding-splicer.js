...
function stubWasi(arg0, arg1, arg2, arg3, arg4) {
  ...
  for (let i = 0; i < vec2.length; i++) {
    ...
    switch (val1) {
      ...
      default: {
        ...
        throw new TypeError(`"${val1}" is not one of the cases of features`);
      }
    }
  ...
  const ret = exports1['stub-wasi'](ptr0, len0, result2, len2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2, variant8_0, variant8_1, variant8_2);
  let variant11;
...
function spliceBindings(arg0, arg1, arg2, arg3, arg4, arg5) {
  ...
  const ret = exports1['splice-bindings'](variant1_0, variant1_1, variant1_2, ptr2, len2, variant4_0, variant4_1, variant4_2, variant6_0, variant6_1, variant6_2, variant8_0, variant8_1, variant8_2, arg5 ? 1 : 0);
  let variant26;
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    case 0: {
      var ptr9 = dataView(memory0).getInt32(ret + 4, true);
...
const $init = (async() => {
  ...
  const module2 = base64Compile('');
  const module3 = base64Compile('');
  ...
  ({ exports: exports1 } = await instantiateCore(await module0, {
    wasi_snapshot_preview1: {
      ...
      fd_prestat_dir_name: exports0['37'],
      fd_prestat_get: exports0['36'],
      fd_read: exports0['27'],
      fd_readdir: exports0['28'],
      fd_write: exports0['29'],
      path_filestat_get: exports0['30'],
      path_open: exports0['31'],
      proc_exit: exports0['38'],
  ...
  ({ exports: exports2 } = await instantiateCore(await module1, {
    ...
    'wasi:cli/terminal-stderr@0.2.0': {
      'get-terminal-stderr': exports0['24'],
    },
    'wasi:cli/terminal-stdin@0.2.0': {
      'get-terminal-stdin': exports0['22'],
    },
    'wasi:cli/terminal-stdout@0.2.0': {
      'get-terminal-stdout': exports0['23'],
    },
    ...
    'wasi:filesystem/types@0.2.0': {
      ...
      '[method]descriptor.get-type': exports0['5'],
      '[method]descriptor.metadata-hash': exports0['10'],
      '[method]descriptor.metadata-hash-at': exports0['11'],
      '[method]descriptor.open-at': exports0['9'],
      '[method]descriptor.read-directory': exports0['6'],
      '[method]descriptor.read-via-stream': exports0['2'],
      '[method]descriptor.stat': exports0['7'],
      '[method]descriptor.stat-at': exports0['8'],
      '[method]descriptor.write-via-stream': exports0['3'],
      '[method]directory-entry-stream.read-directory-entry': exports0['12'],
    ...
    'wasi:io/streams@0.2.0': {
      '[method]input-stream.blocking-read': exports0['15'],
      '[method]input-stream.read': exports0['14'],
